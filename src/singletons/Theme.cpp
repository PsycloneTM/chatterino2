...
void parseInto(const QJsonObject &obj, const QLatin1String &key,
               QColor &color) {
 ...
 *
 * Returns a JSON object containing theme data if the theme is valid, otherwise
 *nullopt
 *
...
bool Theme::isLightTheme() const { return this->isLight_; }
...
Theme *getTheme() { return getApp()->themes; }
