...
# The directory we finally pack into our .snap package
packaging_dir="package"

# Get the Ubuntu Release (e.g. 20.04 or 22.04)
ubuntu_release="$(lsb_release -rs)"

# The final path where we'll save the .snap package
deb_path="Chatterino-ubuntu-${ubuntu_release}-x86_64.snap"
...
echo "Building Ubuntu .snap file on '$ubuntu_release'"
